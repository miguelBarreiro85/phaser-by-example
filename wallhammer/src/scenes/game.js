...
export default class Game extends Phaser.Scene {
  ...
  createMap() {
    ...
    this.shootsGroup = this.add.group();
  ...
  shootHit(shoot, foe) {
    console.log("shoot HIT", this);
    this.blowFoe(undefined, foe);
    shoot.dead = true;
  ...
  shootHitBrick(shoot, brick) {
    console.log("HIT BRICK", shoot, brick);
    brick.destroy();
    shoot.destroy();
  }
  /*
